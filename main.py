...
- When uncertain, use web search to find accurate and up-to-date information
...
- Structure responses clearly with logical organization
...
4. If the question requires current or specific information, use web search to research the topic
